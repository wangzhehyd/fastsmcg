...
conformer_dict = {}
for smi, n_confs, correct_smi in tqdm(test_data.values):
    ...
    mols = []
    #print(model_coords)
    #print(len(model_coords))
    #print(model_coords.split(1, dim=1))
    ...
    conformer_dict[correct_smi] = mols
...
if args.out:
    ...
    with open(f'./test_mols{suffix}.pkl', 'wb') as f:
