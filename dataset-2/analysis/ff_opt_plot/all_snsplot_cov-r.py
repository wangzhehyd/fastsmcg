...
# Last Modified: 2023-02-09 20:16:10
# Version: 1.0
# Description: 
# Copyright: Hou group
#===========================================================
...
f1.legend(handles=handles[0:], labels=labels[0:], frameon=True, edgecolor='white', fontsize=8, loc='lower right')
f1.set_xlim(0,2)
f1.set_ylim(0,100)
...
f2.legend(handles=handles[0:], labels=labels[0:], frameon=True, edgecolor='white', fontsize=8, loc='lower right')
f2.set_xlim(0,2)
f2.set_ylim(0,100)
...
f3.legend(handles=handles[0:], labels=labels[0:], frameon=True, edgecolor='white', fontsize=8, loc='lower right')
f3.set_xlim(0,2)
f3.set_ylim(0,100)
...
f4.legend(handles=handles[0:], labels=labels[0:], frameon=True, edgecolor='white', fontsize=8, loc='lower right')
f4.set_xlim(0,2)
f4.set_ylim(0,100)
...
f5.legend(handles=handles[0:], labels=labels[0:], frameon=True, edgecolor='white', fontsize=8, loc='lower right')
f5.set_xlim(0,2)
f5.set_ylim(0,100)
...
f6.legend(handles=handles[0:], labels=labels[0:], frameon=True, edgecolor='white', fontsize=8, loc='lower right')
f6.set_xlim(0,2)
f6.set_ylim(0,100)
...
f7.legend(handles=handles[0:], labels=labels[0:], frameon=True, edgecolor='white', fontsize=8, loc='lower right')
f7.set_xlim(0,2)
f7.set_ylim(0,100)
...
f8.legend(handles=handles[0:], labels=labels[0:], frameon=True, edgecolor='white', fontsize=8, loc='lower right')
f8.set_xlim(0,2)
f8.set_ylim(0,100)
